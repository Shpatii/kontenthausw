        ...
        <div className="lg:hidden">
          ...
          >
            <img
              src={
                carouselIndex === 0
                  ? "/images/general/f2-min.png"
                  : carouselIndex === 1
                  ? "/images/general/f3-min.png"
                  : "/images/general/f4-min.png"
              }
            ...
            <div className="space-y-4">
              ...
              <div className="w-full h-64">
                <img 
                  src="/images/general/image 7-min.png" 
            ...
            <div className="space-y-4 pb-8">
              ...
              <div className="w-full h-48">
                <img 
                  src="/images/general/Frame 8-min.png" 
